...
// 업태 문자열은 공공데이터의 UPTAENM 실제 값을 그대로 쓴다.
// 데모에서 '중식'을 쓰면 데모에선 필터가 되는데 실데이터('중국식')에선 0건이 나온다.
// 실제로 그 버그를 겪었으므로 여기를 실데이터에 맞춰둔다.
const CATEGORIES = [
  { cat: '한식', menus: [['김치찌개', 7000], ['제육덮밥', 8500], ['된장찌개', 7000], ['불고기백반', 9500], ['순두부찌개', 7500]] },
  { cat: '중국식', menus: [['짜장면', 6500], ['짬뽕', 8000], ['볶음밥', 8000], ['탕수육(소)', 12000]] },
